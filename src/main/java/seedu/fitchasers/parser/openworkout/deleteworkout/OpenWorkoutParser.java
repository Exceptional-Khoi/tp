 ...
 */
public class OpenWorkoutParser implements CommandParser<OpenWorkoutArguments> {
     ...
     */
    @Override
    public OpenWorkoutArguments parse(String raw, YearMonth creationDate) throws InvalidArgumentInput {
        UI ui = new UI();
        ...
        return new OpenWorkoutArguments(id, ym);
    }
